# 🏛️ SABHAPATI: Multi-Agent for Judicial Deliberation

> Courtroom deliberation simulator traversing Indian Evidence Act contexts and compiling case citations.
...
## 🎛️ How It Works
Open the **[Interactive Studio](https://pradeeptalari14.github.io/portfolio/tools/sabhapati-judicial-deliberation/)** in your portfolio dashboard to customize options, select webhook notification channels (Slack/Teams), toggle chat bot connections (WhatsApp Business/Telegram Bot), and download compiled deployment scripts dynamically.
...
```bash
git clone https://github.com/Pradeeptalari14/tp-sabhapati-judicial-deliberation.git
cd tp-sabhapati-judicial-deliberation
```
...
```bash
kubectl port-forward deployment/tp-sabhapati-judicial-deliberation 8080:8080 || echo "Port forwarding enabled on localhost:8080"
```
...
```text
tp-sabhapati-judicial-deliberation/
...
└── primary_config/
    └── court_deliberation.py     # Main configuration file
```
...
---
*Generated by [SABHAPATI: Multi-Agent for Judicial Deliberation Studio](https://pradeeptalari14.github.io/portfolio/tools/sabhapati-judicial-deliberation/) — [Talari Pradeep SRE Portfolio](https://pradeeptalari14.github.io/portfolio)*
